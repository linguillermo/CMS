...
if(isset($_GET['del']))
		  {
		          mysqli_query($con,"delete from medicine_stocks where id = '".$_GET['id']."'");
			...
			if(isset($_POST['add_stock']))
			{
				...
				$sql=mysqli_query($con,"insert into medicine_stocks(medicine_id,quantity) values('$medicine_id','$quantity')");
				$sql1=mysqli_query($con,"update medicines set quantity=quantity + '" . $_POST["quantity"] . "' where ID='" . $_POST["medicine_id"] . "'");
...
if(isset($_POST['edit_medicine']))
			...
			$quantity=$_POST['quantity'];
			$sql=mysqli_query($con,"update medicine_stocks set quantity='$quantity' where id='$id'");
			if($sql)
			{
                    ...
                    <a href="dashboard.php"><i class="fa fa-th-large"></i> <span class="nav-label">Dashboard</span></a>
								...
								<li class="active">
									...
									<ul class="nav nav-second-level collapse">
											...
											<li class= "active"><a href="manage-stocks.php">Stocks</a></li>
									</ul>
								</li>
                            ...
                            <table class="footable table table-stripped" data-page-size="14" data-filter=#filter>
                                <thead>
                                    ...
                                    <tbody>
																			...
																			<?php
$sql=mysqli_query($con,"select * from medicine_stocks");
$cnt=1;
...
?>
																				...
																				<tr>
																					...
																					<?php $query=mysqli_query($con,"select * from medicines where id='".$row['medicine_id']."'");
																									while($row1=mysqli_fetch_array($query))
																									{ ?>

																										<td class="hidden-xs"><?php echo $row1['medicine_name']; ?></td>
																					<td><?php echo $row1['dosage'];?></td>
																					<td><?php echo $row1['formulation'];?></td>
																					<?php } ?>

																					<td><?php echo $row['quantity'];?></td>


																					<td><?php echo date('F j, Y', strtotime($row['stock_date']));?></td>
																					<td >
																						...
																						<a href="manage-stocks.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')" class="btn btn-danger btn-xs">Delete</a>
							                                                ...
							                                                <form role="form" name="" method="post">
							                                                    <div class="form-group row"><label class="col-sm-2 col-form-label">Medicine Name</label>
																																		...
																																		<?php $query=mysqli_query($con,"select * from medicines where id='".$row['medicine_id']."'");
																																						while($row1=mysqli_fetch_array($query))
																																						{ ?>
							                                                                <div class="col-sm-10"><input type="text" name="medicine_name" value="<?php  echo $row1['medicine_name'];?>" class="form-control" disabled></div>
																																	...
																																	<div class="hr-line-dashed"></div>
							                                                    <div class="form-group row"><label class="col-sm-2 col-form-label">Dosage</label>
							                                                        <div class="col-sm-10"><input type="text" name="dosage" value="<?php  echo $row1['dosage'];?>" class="form-control" disabled>
							                                                        </div>
							                                                    </div>

							                                                    <div class="hr-line-dashed"></div>
							                                                    <div class="form-group row"><label class="col-sm-2 col-form-label">Formulation</label>
							                                                        <div class="col-sm-10"><input type="text" name="formulation" value="<?php  echo $row1['formulation'];}?>" class="form-control" disabled>
							                                                        </div>
							                                                    </div>
