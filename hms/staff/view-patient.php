...
mysqli_query($con,"DELETE FROM medicine_stocks WHERE (quantity < 1)");
...
$sql=mysqli_query($con,"update medicine_stocks set quantity=quantity - '" . $_POST["quantity"] . "' where ID='" . $_POST["id"] . "'");
// if($sql)
// {
                                        ...
                                        <form role="form" name="myform" id="myform" method="post">
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Medicine</label>
                                                        ...
                                                        <div class="col-sm-10">
                                                          ...
                                                          <select data-placeholder="Choose a Country..." id="medicine_list" class="chosen-select"  name="id" tabindex="2">

                                                            <?php

                                                                                 $ret=mysqli_query($con,"select * from medicine_stocks");
                                                    ...
                                                    while ($row=mysqli_fetch_array($ret)) {
                                                          ...
                                                          <option value="<?php  echo $row['id'];?>">
                                                            ...
                                                            <?php  echo $row1['medicine_name'];?> <?php  echo $row1['dosage'];?> <?php  echo $row1['formulation']; }?> - <?php echo date('F j, Y', strtotime($row['stock_date']));?> Stock (<?php echo $row['quantity'];?> pcs left)
